...
const SignUp: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const response = await apiUrl.post('/admin/register', {
        name: formData.name,
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-4 px-4 sm:px-6 lg:px-8 bg-gray-2 dark:bg-boxdark">
      <div className="max-w-5xl w-full rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark overflow-hidden">
                ...
                <div className="flex flex-col items-center justify-center py-10 text-center animate-fade-in">
                  <div className="mb-6 flex h-24 w-24 items-center justify-center rounded-full bg-success/10 text-success">
                    <svg
                      ...
                      viewBox="0 0 20 20"
                    >
                      <path d="M10 0C4.477 0 0 4.477 0 10c0 5.523 4.477 10 10 10s10-4.477 10-10c0-5.523-4.477-10-10-10zm4.707 7.707l-6 6a1 1 0 01-1.414 0l-3-3a1 1 0 111.414-1.414L8 11.586l5.293-5.293a1 1 0 011.414 1.414z" />
                    </svg>
                  </div>
                  <h2 className="mb-3 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                    Registration Complete!
                  </h2>
                  <p className="mb-8 font-medium text-bodydark">
                    Your admin account for <b>{formData.name}</b> has been
                    successfully created. You can now access the management
                    dashboard.
                  </p>
                  <Link
                    to="/login"
                    className="flex w-full justify-center rounded-lg bg-primary p-4 font-medium text-white transition hover:bg-opacity-90 active:scale-[0.98] shadow-md"
                  >
                    Go to Sign In
                  </Link>
                </div>
